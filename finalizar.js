...
function confirmarPedido() {
    ...
    fetch("http://localhost:8080/pedido/finalizar", {
        ...
        .then((pedidoCriado) => {
            alert("Pedido finalizado com sucesso! O pagamento deverá ser feito no momento da entrega. " + " Este pedido será enviado para o endereco : " + pedidoCriado.enderecoEntrega);
